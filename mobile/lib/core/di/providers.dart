...
import 'package:daos/features/auth/data/repositories/auth_repository_impl.dart';
...
import 'package:daos/features/dashboard/data/repositories/dashboard_repository_impl.dart';
import 'package:daos/features/dashboard/domain/repositories/dashboard_repository.dart';
import 'package:daos/features/daily_brief/data/datasources/daily_brief_remote_datasource.dart';
import 'package:daos/features/daily_brief/data/repositories/daily_brief_repository_impl.dart';
import 'package:daos/features/daily_brief/domain/repositories/daily_brief_repository.dart';
import 'package:daos/features/settings/data/datasources/settings_remote_datasource.dart';
import 'package:daos/features/settings/data/repositories/settings_repository_impl.dart';
...
import 'package:daos/features/tasks/data/repositories/tasks_repository_impl.dart';
